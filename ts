...
function Chloex:Window(GuiConfig)
    ...
    local ToggleKey = Enum.KeyCode.Backquote
    ...
    function Tabs:AddTab(TabConfig)
        ...
        function Sections:AddSection(Title, AlwaysOpen)
            ...
            function Items:AddInput(InputConfig)
                ...
                InputConfig.NoSave = InputConfig.NoSave or false
                ...
                local InputFunc = { Value = InputConfig.Default, NoSave = InputConfig.NoSave }
                ...
                function InputFunc:Set(Value)
                    ...
                    if InputConfig.NoSave then
                        if Value ~= "" then
                            ConfigData[configKey] = Value
                        else
                            ConfigData[configKey] = nil
                        end
                    else
                        ConfigData[configKey] = Value
                    end
